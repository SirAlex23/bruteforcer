...
**Descripción**  
Script educativo en Python que demuestra un ataque de diccionario contra un hash SHA256. Sirve para practicar conceptos de hashing y comprobar la fortaleza relativa de contraseñas frente a diccionarios.

**Requisitos**  
- Python 3.8+  
- Archivo de diccionario `diccionario.txt` (una palabra por línea)
